...
<head>
  ...
  <!--====== Title ======-->
  <title>Société Freedom Beauty SARL</title>
  <!--====== Favicon Icon ======-->
  <!--====== Bootstrap css ======-->
...
<body>
        ...
        <div class="col-lg-12">
          <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="{{URL::to("/")}}">
              <h4 class="text-white">Freedom Beauty</h4>
            </a>
            ...
            <div class="collapse navbar-collapse sub-menu-bar" id="navbarNine">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <a class="page-scroll" href="#products">Produits</a>
                </li>
                <li class="nav-item">
                    <a class="page-scroll" href="#activity">Activités</a>
                  </li>
                <li class="nav-item">
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 col-12">
          <div class="header-content">
            <h1>La meilleure entreprise pour votre avenir</h1>
            <p>
                Nous aidons les gens à créer une fortune et à travailler pour leur avenir en investissant dans nos produits
            </p>
            <div class="button">
              <a href="#about" class="page scroll btn primary-btn">Voir Plus</a>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-12">
          <div class="about-image-five">
            ...
            <img src="{{__("assets/images/logo-crop.png")}}" alt="about" />
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="about-five-content">
            <h6 class="small-title text-lg">A propos</h6>
            <h2 class="main-title fw-bold">Notre équipe possède l'expérience et les connaissances</h2>
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  <button class="nav-link" id="nav-vision-tab" data-bs-toggle="tab" data-bs-target="#nav-vision"
                    type="button" role="tab" aria-controls="nav-vision" aria-selected="false">Le fondateur</button>
                </div>
              </nav>
  ...
  <!-- ===== service-area start ===== -->
  {{-- <section id="packs" class="services-area services-eight">
    ...
    <div class="container">
        <h3 class="text-green text-center">Pas de packs</h3>
      {{-- <div class="row">
  ...
  <!-- Start Pricing  Area -->
  <section id="products" class="pricing-area pricing-fourteen">
    <!--======  Start Section Title Five ======-->
    <div class="section-title-five">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="content">
              <h6>Produits</h6>
              <h2 class="fw-bold">Nos Produits cosmétiques et alimentaires</h2>
            </div>
          </div>
        </div>
        <!-- row -->
      ...
      <div class="row justify-content-center">
        <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9">
          <div class="inner-content">
            <h2>Nous aimons rendre parfait<br/>solutions pour vous</h2>
            <p>
                Nous fournissons une plate-forme permettant aux personnes d'atteindre la liberté financière, d'où sa structure de marketing avec un système de récompense entièrement automatisé.
            </p>
            <div class="light-rounded-buttons">
              <a href="#" class="btn primary-btn-outline">S'inscrire</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="activity" class="latest-news-area section">
    <!--======  Start Section Title Five ======-->
    <div class="section-title-five">
      <div class="container">
        <div class="row">
              ...
              <div class="col-12 col-md-6 col-xl-12">
                <div class="contact-item">
                  ...
                  <div class="contact-content">
                    ...
                    <p><a href="tel:0529995929" style="color: var(--dark-3)">0529995929</a></p>
                    <p><a href="mailto:stefreedombeauty@gmail.com" style="color: var(--dark-3)">stefreedombeauty@gmail.com</a></p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6 col-xl-12">
                <div class="contact-item">
                  ...
                  <div class="contact-content">
                    <h4>Address</h4>
                    <p>Angle Rue Abdellah Guenoun et rue haj masoud al wafkaoui , Imm Asalam , 3eme étage , Nr 19 , Hay Salam , Agadir</p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6 col-xl-12">
                <div class="contact-item">
                  ...
                  <div class="contact-content">
                    <h4>Horaire</h4>
                    <p>Lundi - Vendredi: 08h00 - 12h00 | 14h00 - 18h00</p>
        ...
        <div class="col-xl-8">
          <div class="contact-form-wrapper">
            ...
            <form action="#" class="contact-form">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="phone" id="phone" placeholder="Numéro de télephone" required />
                </div>
                <div class="col-md-6">
  ...
  <section class="map-section map-style-9">
    <div class="map-container">
      <object style="border:0; height: 500px; width: 100%;"
        data="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d860.2924242119698!2d-9.55058991943838!3d30.402926894623022!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sma!4v1657326255745!5m2!1sen!2sma"></object>
    </div>
    </div>
  </section>
  <!-- ========================= map-section end ========================= -->
