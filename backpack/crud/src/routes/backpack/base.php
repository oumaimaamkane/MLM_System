...
function () {
    ...
    if (config('backpack.base.setup_auth_routes')) {
        ...
        Route::get('register/{id}', 'Auth\RegisterController@showRegistrationFormWithParent')->name('backpack.auth.registerWithParent');
        Route::post('register', 'Auth\RegisterController@register');
        Route::post('register/{id}', 'Auth\RegisterController@registerWithParent');
